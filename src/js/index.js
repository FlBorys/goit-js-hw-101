...
axios.defaults.headers.common["x-api-key"] = "live_oGWsUT7QjZhcPPEwtstxrxM2xJEeFHFqgOyte2dKQbNnkuCIlsEPHLTzwsjSjOuX";
...
function initial() {
    ...
    fetchCatPhoto(selectBreedId)
        .then(result => {
            ...
            const breedData = dataBreed.find(breed => breed.id === catData.breeds[0].id)
